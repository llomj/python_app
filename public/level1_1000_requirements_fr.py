...
# CAS DE TEST :
# Ce cas de test démontre la fonctionality with example inputs.
...
plant = Plant()
print(plant.grow())  # Sortie : The plant is growing.

flower = Flower()
print(flower.grow())  # Sortie : Bloom
...
print(teacher)  # Sortie : Name: John Doe, Subject: Science

math_teacher = MathTeacher("Alice Smith")
print(math_teacher)         # Sortie : Name: Alice Smith, Subject: Math
print(math_teacher.teach_math())  # Sortie : Teaching math concepts.
...
print(writer)  # Sortie : Name: Jane Austen, Genre: Fiction

poet = Poet("William Wordsworth")
print(poet)  # Sortie : Name: William Wordsworth, Genre: Poetry
...
print(artist)  # Sortie : Name: Claude Monet, Medium: Watercolor

painter = Painter("Vincent van Gogh", "Oil Paint")
print(painter)         # Sortie : Name: Vincent van Gogh, Medium: Oil Paint
print(painter.paint()) # Sortie : Painting with Oil Paint
...
# Example usage
worker = Worker()
print(worker.work())  # Sortie : Working on general tasks.

electrician = Electrician()
print(electrician.work())  # Sortie : Fix wires
...
# Example usage
animal = Animal()
print(animal.eat())  # Sortie : Eating food.

lion = Lion()
print(lion.eat())  # Sortie : Eat meat
...
# Example usage
appliance = Appliance()
print(appliance.run())  # Sortie : Running appliance.

fan = Fan()
print(fan.run())  # Sortie : Spin blades
...
# Example usage
employee = Employee()
print(f"Employee Salary: ${employee.get_salary()}")  # Sortie : Employee Salary: $5000

intern = Intern()
print(f"Intern Salary: ${intern.get_salary()}")  # Sortie : Intern Salary: $2000
...
print(vehicle)  # Sortie : Wheels: 4

motorcycle = Motorcycle()
print(motorcycle)  # Sortie : Wheels: 2
...
# Example usage
tool = Tool()
print(tool.use())  # Sortie : Using the tool.

hammer = Hammer()
print(hammer.use())  # Sortie : Hammer nails
...
print(account)  # Sortie : Owner: Alice, Balance: $1000

savings = SavingsAccount(1500, "Bob", 2.5)
print(savings)  # Sortie : Owner: Bob, Balance: $1500, Interest Rate: 2.5%
...
# Example usage
weapon = Weapon()
print(weapon.attack())  # Sortie : Weapon attack

sword = Sword()
print(sword.attack())  # Sortie : Slash
...
print(appliance)  # Sortie : Power: 1500 watts

microwave = Microwave(1200)
print(microwave)  # Sortie : Power: 1200 watts
print(microwave.heat_food())  # Sortie : Heating food
...
# Example usage
vehicle = Vehicle()
print(vehicle.start())  # Sortie : Starting vehicle

electric_car = ElectricCar()
print(electric_car.start())  # Sortie : Silent start
...
# Example usage
pet = Pet()
print(pet.make_sound())  # Sortie : Some generic pet sound

cat = Cat()
print(cat.make_sound())  # Sortie : Meow
...
# Example usage
chef = Chef()
print(chef.cook())  # Sortie : Cook food

pastry_chef = PastryChef()
print(pastry_chef.cook())  # Sortie : Bake cake
...
# Example usage
game = Game(10)
print(game)  # Sortie : Players: 10

soccer = Soccer()
print(soccer)  # Sortie : Players: 22
...
# Example usage
musician = Musician()
print(musician.play_instrument())  # Sortie : Play instrument

pianist = Pianist()
print(pianist.play_instrument())  # Sortie : Play piano
...
print(company)  # Sortie : Name: Global Corp, Location: New York

tech_company = TechCompany("Tech Innovators", "San Francisco", ["Smartphone", "Laptop", "Tablet"])
print(tech_company)  # Sortie : Name: Tech Innovators, Location: San Francisco, Products: Smartphone, Laptop, Tablet
...
# Example usage
gadget = Gadget()
print(gadget.operate())  # Sortie : Operate gadget

smartwatch = Smartwatch(heart_rate_monitor=True)
print(smartwatch.operate())  # Sortie : Operate gadget
print(smartwatch)           # Sortie : Heart Rate Monitor: Enabled
...
# Example usage
trainer = Trainer()
print(trainer.train())  # Sortie : Training session

fitness_trainer = FitnessTrainer()
fitness_trainer.train()  # Sortie : Train body
...
# Example usage
book = Book()
print(book.read())  # Sortie : Read the book

comic_book = ComicBook()
comic_book.read()  # Sortie : Read with pictures
...
print(software)  # Sortie : Name: BasicApp, Version: 1.0

game_software = GameSoftware("EpicQuest", "2.5", "RPG")
print(game_software)  # Sortie : Name: EpicQuest, Version: 2.5, Genre: RPG
...
key_to_check = "banana"
print(check_key_exists(example_dict, key_to_check))  # Sortie : True

key_to_check = "bread"
print(check_key_exists(example_dict, key_to_check))  # Sortie : False
...
print(negated_list)  # Sortie : [False, True, False, True]
