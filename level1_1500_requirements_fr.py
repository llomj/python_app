...
#
# This problem demonstrates la définition de fonction and usage en Python. Functions
...
print(sum_of_digits(string))  # Sortie : 11  # Print the result
...
#
# This problem demonstrates identity comparison using the 'is' operator en Python.
...
#
# This problem demonstrates regular expressions (regex) en Python. Regular
...
#
# This problem demonstrates dictionary operations en Python. Dictionaries are
...
print(get_value(my_dict, 'a'))  # Sortie : 1  # Print the result
print(get_value(my_dict, 'd', 'not found'))  # Sortie : not found  # Print the result
...
#
# This problem demonstrates object-oriented programming concepts en Python.
