...
def is_palindrome(s):                                    # [Line 13]
    return s == s[::-1]                                  # [Line 14] | SLICING OPERATION [::-1] - This is a reverse slice. The syntax [::-1] means: start at the beginning (no start index), stop at the end (no stop index), and step backwards by 1. This effectively reverses the entire sequence. Example: [1,2,3][::-1] becomes [3,2,1] | EQUALITY OPERATOR (==) - Compares two values and returns True if they are equal, False otherwise. Remarque : == checks value equality, not identity (use 'is' for identity).
...
def factorial(n):                                        # [Line 13]
    return 1 if n == 0 else n * factorial(n - 1)         # [Line 14] | EQUALITY OPERATOR (==) - Compares two values and returns True if they are equal, False otherwise. Remarque : == checks value equality, not identity (use 'is' for identity).
...
def sum_n(n):                                            # [Line 13]
    return n if n == 1 else n + sum_n(n - 1)             # [Line 14] | EQUALITY OPERATOR (==) - Compares two values and returns True if they are equal, False otherwise. Remarque : == checks value equality, not identity (use 'is' for identity).
...
def reverse_string(s):                                   # [Line 13]
    return s if len(s) == 0 else s[-1] + reverse_string(s[:-1])  # [Line 14] | SLICING OPERATION [:-1] - Extracts elements from the beginning up to (but not including) index -1.  | EQUALITY OPERATOR (==) - Compares two values and returns True if they are equal, False otherwise. Remarque : == checks value equality, not identity (use 'is' for identity).
...
def is_palindrome(n, temp=None):                         # [Line 13]
    if temp is None:                                     # [Line 14]
        temp = str(n)                                    # [Line 15]
    return True if len(temp) <= 1 else temp[0] == temp[-1] and is_palindrome(n, temp[1:-1])  # [Line 16] | SLICING OPERATION [1:-1] - Extracts elements from index 1 to -2 (stop is exclusive).  | EQUALITY OPERATOR (==) - Compares two values and returns True if they are equal, False otherwise. Remarque : == checks value equality, not identity (use 'is' for identity).
...
def power(x, n):                                         # [Line 13]
    return 1 if n == 0 else x * power(x, n - 1)          # [Line 14] | EQUALITY OPERATOR (==) - Compares two values and returns True if they are equal, False otherwise. Remarque : == checks value equality, not identity (use 'is' for identity).
...
def multiply(a, b):                                      # [Line 13]
    return 0 if b == 0 else a + multiply(a, b - 1)       # [Line 14] | EQUALITY OPERATOR (==) - Compares two values and returns True if they are equal, False otherwise. Remarque : == checks value equality, not identity (use 'is' for identity).
...
def char_count(s, c):                                    # [Line 13]
    return 0 if not s else (1 if s[0] == c else 0) + char_count(s[1:], c)  # [Line 14] | SLICING OPERATION [1:] - Extracts all elements starting from index 1 to the end.  | EQUALITY OPERATOR (==) - Compares two values and returns True if they are equal, False otherwise. Remarque : == checks value equality, not identity (use 'is' for identity).
...
def binary_strings(n, s=""):                             # [Line 13]
    if n == 0:                                           # [Line 14] | EQUALITY OPERATOR (==) - Compares two values and returns True if they are equal, False otherwise. Remarque : == checks value equality, not identity (use 'is' for identity).
        print(s)                                         # [Line 15]
    else:                                                # [Line 16]
...
print(sum_of_digits(string))                             # [Line 21] | PRINT FUNCTION: Outputs one or more values to the console/terminal | WORKFLOW: This is an output statement that displays results to the user | Sortie : 11
...
def triangular_number(n):                                # [Line 13]
    return 0 if n == 0 else n + triangular_number(n - 1)  # [Line 14] | EQUALITY OPERATOR (==) - Compares two values and returns True if they are equal, False otherwise. Remarque : == checks value equality, not identity (use 'is' for identity).
...
def palindrome_generator(lst):                           # [Line 13]
    for word in lst:                                     # [Line 14]
        if word == word[::-1]:                           # [Line 15] | SLICING OPERATION [::-1] - This is a reverse slice. The syntax [::-1] means: start at the beginning (no start index), stop at the end (no stop index), and step backwards by 1. This effectively reverses the entire sequence. Example: [1,2,3][::-1] becomes [3,2,1] | EQUALITY OPERATOR (==) - Compares two values and returns True if they are equal, False otherwise. Remarque : == checks value equality, not identity (use 'is' for identity).
            yield word                                   # [Line 16]
...
def factorial(n):                                        # [Line 13]
    if n == 0 or n == 1:                                 # [Line 14] | EQUALITY OPERATOR (==) - Compares two values and returns True if they are equal, False otherwise. Remarque : == checks value equality, not identity (use 'is' for identity).
        return 1                                         # [Line 15]
...
def is_palindrome(s):                                    # [Line 13]
    if s == s[::-1]:                                     # [Line 14] | SLICING OPERATION [::-1] - This is a reverse slice. The syntax [::-1] means: start at the beginning (no start index), stop at the end (no stop index), and step backwards by 1. This effectively reverses the entire sequence. Example: [1,2,3][::-1] becomes [3,2,1] | EQUALITY OPERATOR (==) - Compares two values and returns True if they are equal, False otherwise. Remarque : == checks value equality, not identity (use 'is' for identity).
        return True                                      # [Line 15]
    else:                                                # [Line 16]
        return False                                     # [Line 17]
...
def is_perfect_number(n):                                # [Line 13]
    ...
    if sum(divisors) == n:                               # [Line 15] | EQUALITY OPERATOR (==) - Compares two values and returns True if they are equal, False otherwise. Remarque : == checks value equality, not identity (use 'is' for identity).
        return True                                      # [Line 16]
    else:                                                # [Line 17]
        return False                                     # [Line 18]
...
def is_armstrong(n):                                     # [Line 13]
    ...
    if total == n:                                       # [Line 17] | EQUALITY OPERATOR (==) - Compares two values and returns True if they are equal, False otherwise. Remarque : == checks value equality, not identity (use 'is' for identity).
        return True                                      # [Line 18]
    else:                                                # [Line 19]
...
def is_power_of_2(n):                                    # [Line 13]
    return n > 0 and (n & (n - 1)) == 0                  # [Line 14] | EQUALITY OPERATOR (==) - Compares two values and returns True if they are equal, False otherwise. Remarque : == checks value equality, not identity (use 'is' for identity).
...
def is_power_of_3(n):                                    # [Line 13]
    ...
    return n == 1                                        # [Line 16] | EQUALITY OPERATOR (==) - Compares two values and returns True if they are equal, False otherwise. Remarque : == checks value equality, not identity (use 'is' for identity).
...
def factorial_recursive(n):                              # [Line 13]
    if n == 1:                                           # [Line 14] | EQUALITY OPERATOR (==) - Compares two values and returns True if they are equal, False otherwise. Remarque : == checks value equality, not identity (use 'is' for identity).
        return 1                                         # [Line 15]
    else:                                                # [Line 16]
...
print(get_value(my_dict, 'a'))                           # [Line 19] | PRINT FUNCTION: Outputs one or more values to the console/terminal | WORKFLOW: This is an output statement that displays results to the user | Sortie : 1
print(get_value(my_dict, 'd', 'not found'))              # [Line 20] | PRINT FUNCTION: Outputs one or more values to the console/terminal | WORKFLOW: This is an output statement that displays results to the user | Sortie : not found
...
def is_dict_empty():                                     # [Line 13]
    sample_dict = {}                                     # [Line 14]
    return len(sample_dict) == 0                         # [Line 15] | EQUALITY OPERATOR (==) - Compares two values and returns True if they are equal, False otherwise. Remarque : == checks value equality, not identity (use 'is' for identity).
...
def find_key_by_value():                                 # [Line 13]
    sample_dict = {"a": 10, "b": 20, "c": 30}            # [Line 14]
    return [k for k, v in sample_dict.items() if v == 20]  # [Line 15] | EQUALITY OPERATOR (==) - Compares two values and returns True if they are equal, False otherwise. Remarque : == checks value equality, not identity (use 'is' for identity).
...
def check_if_empty():                                    # [Line 15]
    p = Path("example_directory")                        # [Line 16]
    return len(list(p.iterdir())) == 0                   # [Line 17] | EQUALITY OPERATOR (==) - Compares two values and returns True if they are equal, False otherwise. Remarque : == checks value equality, not identity (use 'is' for identity).
...
def check_file_extension():                              # [Line 15]
    p = Path("example_file.txt")                         # [Line 16]
    return p.suffix == ".txt"                            # [Line 17] | EQUALITY OPERATOR (==) - Compares two values and returns True if they are equal, False otherwise. Remarque : == checks value equality, not identity (use 'is' for identity).
...
def check_list_conditions():                             # [Line 13]
    lst = [6, 2, 8]                                      # [Line 14]
    return len(lst) == 3 and lst[0] > 5                  # [Line 15] | EQUALITY OPERATOR (==) - Compares two values and returns True if they are equal, False otherwise. Remarque : == checks value equality, not identity (use 'is' for identity).
...
def check_list_length_and_last_element():                # [Line 13]
    ...
    return len(lst) == 5 and lst[-1] > 10                # [Line 15] | EQUALITY OPERATOR (==) - Compares two values and returns True if they are equal, False otherwise. Remarque : == checks value equality, not identity (use 'is' for identity).
...
def check_string():                                      # [Line 13]
    text = "hello"                                       # [Line 14]
    return len(text) == 0 or "e" in text                 # [Line 15] | EQUALITY OPERATOR (==) - Compares two values and returns True if they are equal, False otherwise. Remarque : == checks value equality, not identity (use 'is' for identity).
...
def check_list():                                        # [Line 13]
    lst = [6, 2, 8]                                      # [Line 14]
    return len(lst) == 0 or lst[0] > 5                   # [Line 15] | EQUALITY OPERATOR (==) - Compares two values and returns True if they are equal, False otherwise. Remarque : == checks value equality, not identity (use 'is' for identity).
...
def check_string_empty_or_number():                      # [Line 13]
    ...
    return len(text) == 0 or any(char.isdigit() for char in text)  # [Line 15] | EQUALITY OPERATOR (==) - Compares two values and returns True if they are equal, False otherwise. Remarque : == checks value equality, not identity (use 'is' for identity).
...
def check_list_conditions():                             # [Line 13]
    lst = [1, 2, 3]                                      # [Line 14]
    return len(lst) == 0 or len(lst) > 5                 # [Line 15] | EQUALITY OPERATOR (==) - Compares two values and returns True if they are equal, False otherwise. Remarque : == checks value equality, not identity (use 'is' for identity).
...
def check_list_conditions():                             # [Line 13]
    lst = [6, 2, 8]                                      # [Line 14]
    return len(lst) == 3 or sum(lst) > 50                # [Line 15] | EQUALITY OPERATOR (==) - Compares two values and returns True if they are equal, False otherwise. Remarque : == checks value equality, not identity (use 'is' for identity).
...
print(all(x == row[0] for x in row))                     # [Line 13] | EQUALITY OPERATOR (==) - Compares two values and returns True if they are equal, False otherwise. Remarque : == checks value equality, not identity (use 'is' for identity). | PRINT FUNCTION: Outputs one or more values to the console/terminal | WORKFLOW: This is an output statement that displays results to the user | Expected: True
...
print(all(type(x) == type(t[0]) for x in t))             # [Line 13] | EQUALITY OPERATOR (==) - Compares two values and returns True if they are equal, False otherwise. Remarque : == checks value equality, not identity (use 'is' for identity). | PRINT FUNCTION: Outputs one or more values to the console/terminal | WORKFLOW: This is an output statement that displays results to the user | Expected: True
...
print(a == b)                                            # [Line 14] | EQUALITY OPERATOR (==) - Compares two values and returns True if they are equal, False otherwise. Remarque : == checks value equality, not identity (use 'is' for identity). | PRINT FUNCTION: Outputs one or more values to the console/terminal | WORKFLOW: This is an output statement that displays results to the user | Expected: True
print(a is b)                                            # [Line 15] | PRINT FUNCTION: Outputs one or more values to the console/terminal | WORKFLOW: This is an output statement that displays results to the user | Expected: False
