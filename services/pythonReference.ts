...
_('sys', 'concept', 'import sys', 'The sys module provides access to the running Python interpreter, command-line arguments, import paths, loaded modules, standard streams, and process-exit helpers.', `import sys\nprint(sys.version)\nprint(sys.argv)\nprint(sys.path)`);
