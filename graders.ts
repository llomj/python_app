export type CompareMode = 'exact' | 'float' | 'printedOrReturn' | 'printedFlex' | 'valuesPresent' | 'structuralMatch' | 'lenient' | 'sourceOnly' | 'numberRange' | 'setPop' | 'length' | 'typeName' | 'unorderedList' | 'unorderedWords' | 'numberList' | 'dictUnorderedLists' | 'letterCounts' | 'vowelConsonantCounts';
...
export const AUTO_GRADERS: Record<number, AutoGrader> = {
  ...
  133: {
    ...
    mode: 'script',
    compare: 'printedOrReturn',
    requiredNodePatterns: [{ nodeType: "For", minCount: 2 }],
  ...
  471: {
        ...
        tests: [
            ...
            { args: [[{code: 'zz'}, {code: 'a'}, {code: 'mmmm'}], 'code'], expected: [{code: 'a'}, {code: 'zz'}, {code: 'mmmm'}] }
        ]
    },
  472: {
  ...
  473: {
    functionNames: ["main"],
    tests: [
      { args: [[1, 2, 3, 4, 5], 2], expected: [2, 4, 1, 3, 5] },
      { args: [[10, 11, 12, 13], 3], expected: [12, 10, 13, 11] }
    ]
  },
  474: {
        ...
        tests: [
            ...
            { args: [['1999-12-31', '2024-01-01', '2001-06-15']], expected: ['1999-12-31', '2001-06-15', '2024-01-01'] }
        ]
    },
  475: {
        ...
        tests: [
            { args: [['apple', 'banana', 'cherry', 'date']], expected: ['cherry', 'apple', 'date', 'banana'] },
            { args: [['bbb', 'atlas', 'aardvark']], expected: ['bbb', 'atlas', 'aardvark'] }
        ]
    },
  476: {
  ...
  478: {
        ...
        tests: [
            ...
            { args: [[['aa', 1], ['b', 2], ['cccc', 3]]], expected: [['b', 2], ['aa', 1], ['cccc', 3]] }
        ]
    },
  479: {
        ...
        tests: [
            ...
            { args: [['two spaces here', 'one space', 'zero']], expected: ['zero', 'one space', 'two spaces here'] }
        ]
    },
  480: {
        ...
        tests: [
            { args: [['apple', 'banana', 'cherry', 'date']], expected: 'banana' },
            { args: [['sky', 'audio', 'tree']], expected: 'audio' }
        ]
    },
  481: {
        ...
        tests: [
            ...
            { args: [[-10, 3, 200, -4]], expected: [3, -4, -10, 200] }
        ]
    },
  482: {
        ...
        tests: [
            ...
            { args: [[[5, 5], [2, 8], [9, 7]]], expected: [[5, 5], [9, 7], [2, 8]] }
        ]
    },
  483: {
        ...
        tests: [
            { args: [['banana', 'Apple', 'cherry']], expected: ['Apple', 'banana', 'cherry'] },
            { args: [['zoo', 'ant', 'Dog']], expected: ['Dog', 'ant', 'zoo'] }
        ]
    },
  484: {
        ...
        tests: [
            ...
            { args: [[[5], [1, 1, 1], [2, 2]]], expected: [[1, 1, 1], [2, 2], [5]] }
        ]
    },
  485: {
        functionNames: ['number_of_consonants'],
        tests: [
            ...
            { args: [['aeiou', 'cat', 'sky']], expected: 'aeiou' }
        ]
    },
  486: {
  ...
  488: {
        ...
        tests: [
            { args: [['apple', 'banana', 'cherry', 'date']], expected: ['banana', 'apple', 'date', 'cherry'] },
            { args: [['aaa', 'ab', 'abc']], expected: ['aaa', 'ab', 'abc'] }
        ]
    },
  489: {
        ...
        tests: [
            ...
            { args: [['za', 'ab', 'cc']], expected: ['za', 'ab', 'cc'] }
        ]
    },
  490: {
        ...
        tests: [
            ...
            { args: [[{name: 'Young', age: 10}, {name: 'Old', age: 80}]], expected: [{name: 'Young', age: 10}, {name: 'Old', age: 80}] }
        ]
    },
  491: {
  ...
  494: {
        ...
        tests: [
            ...
            { args: [['sun', 'moon', 'star'], 'n'], expected: 'moon' }
        ]
    },
  495: {
  ...
  502: {
        functionNames: ['EBook'],
        requiredNodePatterns: [{ nodeType: "ClassDef", minCount: 2 }],
        requiredClassInheritance: [{ className: "EBook", baseName: "Book" }],
        tests: [
            ...
            { args: ['Clean Code', 'Robert Martin', 1.8], getAttrs: ['title', 'author', 'file_size'], expected: {title: 'Clean Code', author: 'Robert Martin', file_size: 1.8} }
        ]
    },
  503: {
  ...
  506: {
        ...
        tests: [
            ...
            { args: ['Apple', 'M3', 1.5], getAttrs: ['brand', 'processor', 'weight'], expected: {brand: 'Apple', processor: 'M3', weight: 1.5} }
        ]
    },
  507: {
  ...
  509: {
        ...
        tests: [
            ...
            { args: [80, '9 Tower Ave', 350], getAttrs: ['floors', 'address', 'height'], expected: {floors: 80, address: '9 Tower Ave', height: 350} }
        ]
    },
  510: {
  ...
  512: {
        ...
        tests: [
            ...
            { args: ['Maya Angelou'], getAttrs: ['name', 'genre'], expected: {name: 'Maya Angelou', genre: 'Poetry'} }
        ]
    },
  513: {
  ...
  514: {
        ...
        tests: [
            ...
            { args: ['Frida Kahlo', 'Acrylic'], callMethod: 'paint', expected: 'Painting with Acrylic' }
        ]
    },
  515: {
  ...
  521: {
        ...
        tests: [
            ...
            { args: [250, 'Alice', 4], getAttrs: ['balance', 'owner', 'interest_rate'], expected: {balance: 250, owner: 'Alice', interest_rate: 4} }
        ]
    },
  522: {
  ...
  527: {
        ...
        tests: [
            ...
            { args: ['metal', 'black', 3], getAttrs: ['material', 'color', 'legs'], expected: {material: 'metal', color: 'black', legs: 3} }
        ]
    },
  528: {
  ...
  530: {
        ...
        tests: [
            ...
            { args: ['Cloud Labs', 'Austin', ['API', 'Dashboard']], getAttrs: ['name', 'location', 'products'], expected: {name: 'Cloud Labs', location: 'Austin', products: ['API', 'Dashboard']} }
        ]
    },
  531: {
  ...
  534: {
        ...
        tests: [
            ...
            { args: ['SpeedRun', '1.0', 'Racing'], getAttrs: ['name', 'version', 'genre'], expected: {name: 'SpeedRun', version: '1.0', genre: 'Racing'} }
        ]
    },
  535: {
  ...
  543: {
        ...
        tests: [
            ...
            { args: ['words.txt', 'python'], setupFiles: {'words.txt': 'python ruby python\njavascript'}, expected: 2 }
        ]
    },
  544: {
  ...
  546: {
        ...
        tests: [
            ...
            { args: ['contest test retest'], expected: 3 }
        ]
    },
  547: {
        ...
        tests: [
            ...
            { args: [[0.5, 0.5, 1.0], 0.5], expected: 2 }
        ]
    },
  548: {
        functionNames: ['count_floating_numbers'],
        tests: [
            ...
            { args: [[1.1, 1.1, 2.2], 2.2], expected: 1 }
        ]
    },
  549: {
        functionNames: ['count_uppercase'],
  ...
  552: {
        ...
        tests: [
            ...
            { args: ['python PYTHON PyThOn'], expected: 3 }
        ]
    },
  553: {
        ...
        tests: [
            ...
            { args: [[{x: 1}, {x: 1}, {x: 2}], {x: 2}], expected: 1 }
        ]
    },
  554: {
        functionNames: ['count_letters'],
  ...
  557: {
        ...
        tests: [
            ...
            { args: ['log.txt', 'warn'], setupFiles: { 'log.txt': 'WARN first\nok\nwarning second\nclear' }, expected: 2 }
        ]
    },
  558: {
        ...
        tests: [
            ...
            { args: [['a@test.com', 'b@test.com', 'c@mail.com'], 'test.com'], expected: 2 }
        ]
    },
  559: {
        ...
        tests: [
            ...
            { args: [['happy happy', 'unhappy', 'sad']], expected: 3 }
        ]
    },
  560: {
  ...
  561: {
        ...
        tests: [
            ...
            { args: ['red blue red green red', 'red'], expected: 3 }
        ]
    },
  562: {
  ...
  564: {
        ...
        tests: [
            ...
            { args: ['banana', 'a'], expected: "The letter 'a' appears 3 times in the given string." }
        ]
    },
  565: {
  ...
  572: {
        ...
        tests: [
            ...
            { args: [['noon', 'python', 'madam']], expected: ['noon', 'madam'] }
        ]
    },
  573: {
  ...
  578: {
        ...
        tests: [
            ...
            { args: [['cat', 'boat', 'tree']], expected: ['boat', 'tree'] }
        ]
    },
  579: {
  ...
  584: {
        ...
        tests: [
            ...
            { args: [['ok', 'no!', 'YES']], expected: ['ok', 'YES'] }
        ]
    },
  585: {
        ...
        tests: [
            ...
            { args: [['red', 'blue', 'red']], expected: {red: 2, blue: 1} }
        ]
    },
  586: {
  ...
  587: {
        ...
        tests: [
            ...
            { args: [['tree', 'mountain', 'sun'], 4], expected: ['mountain'] }
        ]
    },
  588: {
  ...
  593: {
        ...
        tests: [
            { args: [['a', 'ab', 'abc']], expected: 'abc' },
            { args: [['short', 'longest', 'mid']], expected: 'longest' }
        ]
    },
  594: {
  ...
  596: {
        ...
        tests: [
            ...
            { args: [['red', 'red', 'blue']], expected: {red: 2, blue: 1} }
        ]
    },
  597: {
        functionNames: ['lst_words'],
        tests: [
            ...
            { args: [['rat', 'tar', 'art', 'cat'], 'rat'], expected: ['cat'] }
        ]
    },
  598: {
  ...
  599: {
        ...
        tests: [
            ...
            { args: [['hi', 'to', 'sun']], expected: {2: ['hi', 'to'], 3: ['sun']} }
        ]
    },
  600: {
  ...
  601: {
        ...
        tests: [
            ...
            { args: [[5, 6]], argFunctionNames: ['example_func'], expected: [0, 6] }
        ]
    },
  602: {
        functionNames: ['intersection'],
  ...
  609: {
        ...
        tests: [
            ...
            { args: [['Ada Lovelace', 'Grace Hopper']], expected: ['Grace Hopper', 'Ada Lovelace'] }
        ]
    },
  610: {
        ...
        tests: [
            { args: [['banana', 'Apple', 'cherry', 'Date']], expected: ['Apple', 'banana', 'cherry', 'Date'] },
            { args: [['Zoo', 'ant', 'Bee']], expected: ['ant', 'Bee', 'Zoo'] }
        ]
    },
  611: {
        ...
        tests: [
            ...
            { args: [[0.5, -1.2, 2.0]], expected: [2.0, 0.5, -1.2] }
        ]
    },
  612: {
        functionNames: ['lst_words'],
  ...
  613: {
        ...
        tests: [
            ...
            { args: [[{name: 'Old', age: 80}, {name: 'Young', age: 10}]], expected: [{name: 'Young', age: 10}, {name: 'Old', age: 80}] }
        ]
    },
  614: {
  ...
  615: {
        ...
        tests: [
            ...
            { args: [[{name: 'X', price: 3}, {name: 'Y', price: 1}]], expected: [{name: 'Y', price: 1}, {name: 'X', price: 3}] }
        ]
    },
  616: {
        ...
        tests: [
            ...
            { args: [['2020-12-31', '2020-01-01']], expected: ['2020-01-01', '2020-12-31'] }
        ]
    },
  617: {
        ...
        tests: [
            ...
            { args: [[[2, 2], [1, 9], [1, 1]]], expected: [[1, 1], [1, 9], [2, 2]] }
        ]
    },
  618: {
        ...
        tests: [
            ...
            { args: [['Zoe', 'Al', 'Charlotte']], expected: ['Al', 'Zoe', 'Charlotte'] }
        ]
    },
  619: {
        ...
        tests: [
            ...
            { args: [[['A', '2022-01-01'], ['B', '2020-01-01']]], expected: [['B', '2020-01-01'], ['A', '2022-01-01']] }
        ]
    },
  620: {
        ...
        tests: [
            ...
            { args: [['long sentence', 'tiny']], expected: ['tiny', 'long sentence'] }
        ]
    },
  621: {
        ...
        tests: [
            ...
            { args: [['ant', 'ape', 'bee']], expected: ['bee', 'ant', 'ape'] }
        ]
    },
  622: {
  ...
  623: {
        ...
        tests: [
            ...
            { args: [['apple', 'zoo']], expected: ['zoo', 'apple'] }
        ]
    },
  624: {
        ...
        tests: [
            ...
            { args: [[30, -10, 10]], expected: [-10, 10, 30] }
        ]
    },
  625: {
  ...
  626: {
        ...
        tests: [
            ...
            { args: [['x@z.com', 'a@a.com']], expected: ['a@a.com', 'x@z.com'] }
        ]
    },
  627: {
  ...
  869: {
    ...
    requiredUnpackPatterns: [{ targetCount: 3, sourceType: "List" }],
    tests: [
      { args: [], expected: null }
    ]
  },
  870: {
    ...
    requiredUnpackPatterns: [{ targetCount: 3, sourceType: "List", allowStarred: true }],
    tests: [
      { args: [], expected: null }
    ]
  },
  871: {
    ...
    requiredUnpackPatterns: [{ targetCount: 2, sourceType: "Any" }],
    tests: [
      { args: [], expected: null }
    ]
  },
  ...
  874: {
    ...
    compare: 'sourceOnly',
    requiredNodePatterns: [{nodeType: "Starred"}],
    requiredUnpackPatterns: [{ targetCount: 3, sourceType: "Any", allowStarred: true }],
    tests: [
      { args: [], expected: null }
    ]
  },
  875: {
    ...
    compare: 'sourceOnly',
    requiredNodePatterns: [{nodeType: "Starred"}],
    requiredUnpackPatterns: [{ targetCount: 3, sourceType: "Tuple", allowStarred: true }],
    tests: [
      { args: [], expected: null }
    ]
  },
  ...
  877: {
    ...
    requiredCallPatterns: [{functionName: "range"}],
    requiredNodePatterns: [{nodeType: "Tuple"}],
    requiredUnpackPatterns: [{ targetCount: 3, sourceType: "Any" }],
    tests: [
      { args: [], expected: null }
    ]
  },
  ...
  953: {
    ...
    mode: 'script',
    compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "count"}],
    tests: [
      { args: [], expected: null }
    ]
  },
  954: {
    ...
    mode: 'script',
    compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "startswith"}],
    tests: [
      { args: [], expected: null }
    ]
  },
  955: {
    ...
    mode: 'script',
    compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "replace"}],
    tests: [
      { args: [], expected: null }
    ]
  },
  ...
  957: {
    ...
    mode: 'script',
    compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "join"}],
    tests: [
      { args: [], expected: null }
    ]
  },
  958: {
    ...
    mode: 'script',
    compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "strip"}],
    tests: [
      { args: [], expected: null }
    ]
  },
  ...
  960: {
    ...
    mode: 'script',
    compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "sort"}],
    tests: [
      { args: [], expected: null }
    ]
  },
  961: {
    ...
    mode: 'script',
    compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "reverse"}],
    tests: [
      { args: [], expected: null }
    ]
  },
  962: {
    ...
    mode: 'script',
    compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "append"}],
    tests: [
      { args: [], expected: null }
    ]
  },
  ...
  964: {
    ...
    mode: 'script',
    compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "remove"}],
    tests: [
      { args: [], expected: null }
    ]
  },
  ...
  969: {
    ...
    mode: 'script',
    compare: 'sourceOnly',
    requiredNodePatterns: [{ nodeType: "Set" }, { nodeType: "Compare" }],
    tests: [
      { args: [], expected: null }
    ]
  },
  ...
  1221: {
    ...
    requiredCallPatterns: [{ functionName: "Path" }],
    tests: [{
      args: [],
  ...
  1402: {
    ...
    mode: 'script',
    compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "enumerate"}],
    requiredNodePatterns: [{nodeType: "For"}, {nodeType: "Tuple"}],
    tests: [
      { args: [], expected: null }
    ]
  ...
  1405: {
    ...
    mode: 'script',
    compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "all"}],
    tests: [
      { args: [], expected: null }
    ]
  },
  ...
  1407: {
    ...
    mode: 'script',
    compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "map"}],
    tests: [
      { args: [], expected: null }
    ]
  },
  1408: {
    ...
    mode: 'script',
    compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "filter"}],
    requiredNodePatterns: [{nodeType: "Lambda"}],
    tests: [
      { args: [], expected: null }
    ]
  ...
  1413: {
    ...
    mode: 'script',
    compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "chain"}],
    tests: [
      { args: [], expected: null }
    ]
  },
  1414: {
    ...
    mode: 'script',
    compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "split"}, {functionName: "capitalize"}, {functionName: "join"}],
    tests: [
      { args: [], expected: null }
    ]
  },
  ...
  1418: {
    ...
    mode: 'script',
    compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "groupby"}],
    requiredNodePatterns: [{nodeType: "DictComp"}],
    tests: [
      { args: [], expected: null }
    ]
  ...
  1419: {
    ...
    mode: 'script',
    compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "maketrans"}, {functionName: "translate"}],
    tests: [
      { args: [], expected: null }
    ]
  },
  1420: {
    ...
    mode: 'script',
    compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "frozenset"}],
    tests: [
      { args: [], expected: null }
    ]
  },
  1421: {
    ...
    mode: 'script',
    compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "combinations"}],
    tests: [
      { args: [], expected: null }
    ]
  },
  1422: {
    ...
    mode: 'script',
    compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "deque"}, {functionName: "append"}, {functionName: "popleft"}],
    tests: [
      { args: [], expected: null }
    ]
  },
  1423: {
    ...
    mode: 'script',
    compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "partition"}],
    tests: [
      { args: [], expected: null }
    ]
  },
  1424: {
    ...
    mode: 'script',
    compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "sorted"}, {functionName: "itemgetter"}],
    tests: [
      { args: [], expected: null }
    ]
  },
  ...
  1427: {
    ...
    mode: 'script',
    compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "sum"}],
    requiredNodePatterns: [{nodeType: "GeneratorExp"}],
    tests: [
      { args: [], expected: null }
    ]
  },
  ...
  1436: {
    ...
    mode: 'script',
    compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "open"}, {functionName: "read"}],
    requiredNodePatterns: [{nodeType: "With"}],
    tests: [
      { args: [], expected: null }
    ]
  },
  ...
  1452: {
    ...
    mode: 'script',
    compare: 'printedOrReturn',
    requiredCallPatterns: [{functionName: "all"}, {functionName: "islower"}],
    tests: [
      { args: [], expected: "True" }
    ]
  },
  ...
  1454: {
    ...
    mode: 'script',
    compare: 'printedOrReturn',
    requiredCallPatterns: [{functionName: "all"}, {functionName: "values"}],
    tests: [
      { args: [], expected: "True" }
    ]
  },
  ...
  1456: {
    ...
    mode: 'script',
    compare: 'printedOrReturn',
    requiredCallPatterns: [{functionName: "all"}, {functionName: "isupper"}],
    tests: [
      { args: [], expected: "True" }
    ]
  },
  ...
  1458: {
    ...
    mode: 'script',
    compare: 'printedOrReturn',
    requiredCallPatterns: [{functionName: "all"}, {functionName: "isinstance"}],
    tests: [
      { args: [], expected: "True" }
    ]
  },
  1459: {
    ...
    mode: 'script',
    compare: 'printedOrReturn',
    requiredCallPatterns: [{functionName: "all"}, {functionName: "isinstance"}, {functionName: "keys"}],
    tests: [
      { args: [], expected: "True" }
    ]
  },
  1460: {
    ...
    mode: 'script',
    compare: 'printedOrReturn',
    requiredCallPatterns: [{functionName: "all"}, {functionName: "endswith"}],
    tests: [
      { args: [], expected: "True" }
    ]
  },
  ...
  1465: {
    ...
    mode: 'script',
    compare: 'printedOrReturn',
    requiredCallPatterns: [{functionName: "all"}, {functionName: "zip"}],
    tests: [
      { args: [], expected: "True" }
    ]
  },
  ...
  1467: {
    ...
    mode: 'script',
    compare: 'printedOrReturn',
    requiredCallPatterns: [{functionName: "all"}, {functionName: "type"}],
    tests: [
      { args: [], expected: "True" }
    ]
  },
  ...
  1470: {
    ...
    mode: 'script',
    compare: 'printedOrReturn',
    requiredCallPatterns: [{functionName: "all"}, {functionName: "len"}],
    tests: [
      { args: [], expected: "True" }
    ]
  },
  ...
  1477: {
    ...
    mode: 'script',
    compare: 'printedOrReturn',
    requiredNodePatterns: [{nodeType: "FunctionDef"}, {nodeType: "Compare"}],
    tests: [
      { args: [], expected: "True" }
    ]
  },
  1478: {
    ...
    mode: 'script',
    compare: 'printedOrReturn',
    requiredNodePatterns: [{nodeType: "ClassDef"}, {nodeType: "Compare"}],
    tests: [
      { args: [], expected: "True" }
    ]
  },
  ...
  1483: {
    ...
    mode: 'script',
    compare: 'printedOrReturn',
    requiredNodePatterns: [{nodeType: "Assert"}, {nodeType: "Compare"}],
    tests: [
  ...
  1490: {
    ...
    mode: 'script',
    compare: 'printedOrReturn',
    requiredNodePatterns: [{nodeType: "Compare", minCount: 2}],
    tests: [
      { args: [], expected: "True\nFalse" }
    ]
  },
  ...
  1512: {
    ...
    mode: 'script',
    compare: 'printedOrReturn',
    requiredCallPatterns: [{functionName: "min", keyword: "default"}, {functionName: "get"}],
    tests: [
  ...
  1537: {
    ...
    mode: 'script',
    compare: 'printedOrReturn',
    requiredCallPatterns: [{functionName: "max", keyword: "default"}, {functionName: "get"}],
    tests: [
      { args: [], expected: "999" }
    ]
  },
  ...
  1579: {
        ...
        mode: 'script',
        compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "ExitStack"}, {functionName: "enter_context"}],
    requiredNodePatterns: [{nodeType: "With"}],
        tests: [
            { args: [], expected: null },
        ]
  ...
  1580: {
        ...
        mode: 'script',
        compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "Path"}, {functionName: "exists"}],
        tests: [
            { args: [], setupFiles: { "example.txt": "exists" }, expected: null },
        ]
    },
  1581: {
        functionNames: [],
  ...
  1588: {
        ...
        mode: 'script',
        compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "OrderedDict"}],
        tests: [
            { args: [], expected: null },
        ]
    },
  1589: {
        ...
        mode: 'script',
        compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "ChainMap"}],
        tests: [
            { args: [], expected: null },
        ]
    },
  1590: {
        ...
        mode: 'script',
        compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "namedtuple"}],
        tests: [
            { args: [], expected: null },
        ]
    },
  ...
  1593: {
        ...
        mode: 'script',
        compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "attrgetter"}, {functionName: "sorted"}],
    requiredNodePatterns: [{nodeType: "ClassDef"}],
        tests: [
            { args: [], expected: null },
        ]
  ...
  1594: {
        ...
        mode: 'script',
        compare: 'sourceOnly',
        requiredCallPatterns: [{functionName: "methodcaller"}],
        tests: [
            { args: [], expected: null },
        ]
    },
  1595: {
        ...
        mode: 'script',
        compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "removeprefix"}],
        tests: [
            { args: [], expected: null },
        ]
    },
  1596: {
        ...
        mode: 'script',
        compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "removesuffix"}],
        tests: [
            { args: [], expected: null },
        ]
    },
  1597: {
        ...
        mode: 'script',
        compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "rsplit"}],
        tests: [
            { args: [], expected: null },
        ]
    },
  ...
  1607: {
        ...
        mode: 'script',
        compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "redirect_stdout"}, {functionName: "StringIO"}, {functionName: "getvalue"}],
    requiredNodePatterns: [{nodeType: "With"}],
        tests: [
            { args: [], expected: null },
        ]
  ...
  1610: {
        ...
        mode: 'script',
        compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "combinations_with_replacement"}],
        tests: [
            { args: [], expected: null },
        ]
    },
  1611: {
        ...
        mode: 'script',
        compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "dropwhile"}],
        tests: [
            { args: [], expected: null },
        ]
    },
  1612: {
        ...
        mode: 'script',
        compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "takewhile"}],
        tests: [
            { args: [], expected: null },
        ]
    },
  1613: {
        ...
        mode: 'script',
        compare: 'sourceOnly',
    requiredCallPatterns: [{functionName: "starmap"}],
        tests: [
            { args: [], expected: null },
        ]
    },
  ...
  1627: {
        ...
        mode: 'script',
        compare: 'sourceOnly',
        requiredCallPatterns: [{functionName: "Path"}, {functionName: "read_text"}],
        tests: [
            { args: [], setupFiles: {"file.txt": "Hello, pathlib!"}, expected: null },
        ]
    },
  1628: {
        functionNames: [],
        mode: 'script',
        compare: 'sourceOnly',
        requiredCallPatterns: [{functionName: "Path"}, {functionName: "write_text"}],
        tests: [
            { args: [], expected: null },
        ]
    },
  1629: {
        ...
        mode: 'script',
        compare: 'sourceOnly',
        requiredCallPatterns: [{functionName: "Path"}, {functionName: "glob"}],
        tests: [
            { args: [], setupFiles: {"a.py": "", "b.py": "", "notes.txt": ""}, expected: null },
        ]
    },
  1630: {
        functionNames: [],
  ...
  1634: {
        ...
        mode: 'script',
        compare: 'sourceOnly',
        requiredCallPatterns: [{functionName: "OrderedDict"}, {functionName: "move_to_end"}],
        tests: [
            { args: [], expected: null },
        ]
    },
  1635: {
        ...
        mode: 'script',
        compare: 'sourceOnly',
        requiredCallPatterns: [{functionName: "ChainMap"}, {functionName: "new_child"}],
        tests: [
            { args: [], expected: null },
        ]
    },
  1636: {
        ...
        mode: 'script',
        compare: 'sourceOnly',
        requiredCallPatterns: [{functionName: "namedtuple"}, {functionName: "_replace"}],
        tests: [
            { args: [], expected: null },
        ]
    },
  ...
  1638: {
        ...
        mode: 'script',
        compare: 'sourceOnly',
        requiredNodePatterns: [{nodeType: "SetComp"}],
        tests: [
            { args: [], expected: null },
        ]
    },
  ...
  1644: {
        ...
        mode: 'script',
        compare: 'sourceOnly',
        requiredCallPatterns: [{functionName: "extend"}],
        tests: [
            { args: [], expected: null },
        ]
    },
  ...
  1892: {
        ...
        tests: [
            ...
            { args: [12,30,5], expected: "12:30:05" },
        ]
    },
  1893: {
  ...
  1897: {
        ...
        tests: [
            ...
            { args: ["Py3"], expected: {"uppercase":1,"lowercase":1} },
        ]
    },
  1898: {
  ...
  1899: {
        ...
        tests: [
            { args: [[1,2,3],[2,3,4],[2,3,5]], expected: [2,3] },
            { args: [["a","b","c"],["b","c","d"],["c","b"]], expected: ["b","c"] },
        ]
    },
  1900: {
        functionNames: ['calculate_percentage'],
  ...
  1904: {
        ...
        tests: [
            ...
            { args: ["Ice cream and cake"], expected: ["Ice","and"] },
        ]
    },
  1905: {
        ...
        tests: [
            ...
            { args: ["sky tree run"], expected: ["sky","run"] },
        ]
    },
  1906: {
  ...
  1912: {
        ...
        tests: [
            ...
            { args: [["cat","car","dog"],"ca"], expected: ["cat","car"] },
        ]
    },
  1913: {
    ...
    tests: [{
      ...
      args: ["a1!"],
      expected: {"letters": 1, "digits": 1, "others": 1}
    }]
  },
  1914: {
  ...
  1915: {
        ...
        tests: [
            ...
            { args: [2024,1,5], expected: "2024-01-05" },
        ]
    },
  1916: {
  ...
  1918: {
        ...
        tests: [
            ...
            { args: ["cat bat dog","at"], expected: 2 },
        ]
    },
  1919: {
  ...
  1920: {
        ...
        tests: [
            ...
            { args: ["Bob",30,"LA"], expected: "Name: Bob, Age: 30, City: LA" },
        ]
    },
  1921: {
  ...
  1929: {
        ...
        tests: [
            ...
            { args: ["hi to code",2], expected: ["hi","to"] },
        ]
    },
  1930: {
    ...
    tests: [{
      ...
      args: ["123", "Main St", "NYC", "NY", "10001"],
      expected: "123 Main St, NYC, NY 10001"
    }]
  },
  1931: {
        ...
        tests: [
            ...
            { args: [[100,50],10,8], expected: 145.8 },
        ]
    },
  1932: {
  ...
  1933: {
        ...
        tests: [
            ...
            { args: ["tester","runner"], expected: "er" },
        ]
    },
  1934: {
  ...
  1938: {
    ...
    tests: [{
      ...
      args: ["Alice", 30, "alice@example.com"],
  ...
  1939: {
        ...
        tests: [
            ...
            { args: [[6,12,18,20],[2,3]], expected: [6,12,18] },
        ]
    },
  1940: {
        ...
        tests: [
            ...
            { args: ["sky tree"], expected: {"sky":0,"tree":2} },
        ]
    },
  1941: {
        ...
        tests: [
            ...
            { args: ["sky tree apple",0], expected: ["sky"] },
        ]
    },
  1942: {
  ...
  1944: {
        ...
        tests: [
            ...
            { args: [[10,20,30],[1,2,3]], expected: 23.333333333333332 },
        ]
    },
  1945: {
        ...
        tests: [
            { args: [["abc","a","ab"]], expected: ["a","ab","abc"] },
            { args: [["python","a","hello","world"]], expected: ["a","hello","world","python"] },
        ]
    },
  1946: {
  ...
  1947: {
        ...
        tests: [
            ...
            { args: [[1,2,3,4,5],7], expected: [[2,5],[3,4]] },
        ]
    },
  1948: {
    ...
    tests: [{
      ...
      args: ["Hi 123!"],
      expected: {"vowels": 1, "consonants": 1, "digits": 3, "spaces": 1}
    }]
  },
  1949: {
        compare: 'dictUnorderedLists',
        ...
        tests: [
            ...
            { args: ["sky tree apple"], expected: {"0":["sky"],"2":["tree","apple"]} },
        ]
    },
  1950: {
        ...
        tests: [
            ...
            { args: ["Ada","Lovelace","Prof"], expected: "Prof. Ada Lovelace" },
        ]
    },
  1951: {
  ...
  1952: {
        ...
        tests: [
            ...
            { args: [["a","b","c"],[1,2]], expected: {"1":"b","2":"c"} },
        ]
    },
  1953: {
    ...
    tests: [{
      ...
      args: ["A1!"],
      expected: {"has_uppercase": true, "has_lowercase": false, "has_digit": true, "has_special": true}
    }]
  },
  1954: {
  ...
  1961: {
        ...
        tests: [
            ...
            { args: [["hi","to","code"]], expected: {"2":["hi","to"],"4":["code"]} },
        ]
    },
  1962: {
  ...
  1963: {
        ...
        tests: [
            ...
            { args: [[10,20,30,40],1,4], expected: 90 },
        ]
    },
  1964: {
  ...
  1965: {
        ...
        tests: [
            ...
            { args: [[10,20,30,40,50],15,45], expected: [20,30,40] },
        ]
    },
  1966: {
  ...
  1971: {
        ...
        tests: [
            ...
            { args: ["John","Michael","Doe"], expected: "J.M.D." },
        ]
    },
  1972: {
  ...
  1974: {
        ...
        tests: [
            ...
            { args: ["cat moon sky"], expected: ["moon"] },
        ]
    },
  1975: {
    ...
    tests: [{
      ...
      args: ["Alice", [85, 90, 88]],
      expected: "Name: Alice, Scores: 85, 90, 88"
    }]
  },
  1976: {
  ...
  1977: {
        ...
        tests: [
            ...
            { args: ["apple apricot banana cherry"], expected: {"a":2,"b":1,"c":1} },
        ]
    },
  1978: {
  ...
  1981: {
        ...
        tests: [
            ...
            { args: [["education","hello","facetious"]], expected: ["education","facetious"] },
        ]
    },
  1982: {
    ...
    tests: [{
      ...
      args: [[10.5, 20.75, 30.25]],
      expected: ["$10.50", "$20.75", "$30.25"]
    }]
  },
  1983: {
  ...
  1985: {
        ...
        tests: [
            ...
            { args: ["hello world python programming"], expected: ["world","python","hello","programming"] },
        ]
    },
  1986: {
        ...
        tests: [
            ...
            { args: ["Bob",20,"B"], expected: "Bob (Age: 20) - Grade: B" },
        ]
    },
  1987: {
        ...
        tests: [
            { args: [[1,2,2,3,3,3]], expected: [3] },
            { args: [[1,2,2,3,3,3,4,4,4]], expected: [3,4] },
        ]
    },
  1988: {
  ...
  1989: {
    ...
    tests: [{
      ...
      expected: "Item 1: apple, Item 2: banana, Item 3: cherry"
    }]
  },
  1990: {
  ...
  1993: {
        ...
        tests: [
            ...
            { args: [[["Ann", 1], ["Bob", 22]]], expected: "Ann        | 1\nBob        | 22" },
        ]
    },
  1994: {
        ...
        tests: [
            ...
            { args: ["cat moon sky"], expected: ["cat","sky"] },
        ]
    },
  1995: {
  ...
  1996: {
    ...
    tests: [{
      ...
      args: ["Ada", "9 Elm", "Austin", "TX", "73301"],
      expected: "Ada\n9 Elm\nAustin, TX 73301"
    }]
  },
  1997: {
  ...
  1998: {
    ...
    tests: [{
      ...
      args: [[10, 20, 30, 40, 50]],
      expected: {"mean": 30, "median": 30, "min": 10, "max": 50, "range": 40}
    }]
  },
  1999: {
    ...
    tests: [{
      ...
      args: ["Alice", "555-1234", "alice@example.com", "123 Main St"],
      expected: "Name: Alice\nPhone: 555-1234\nEmail: alice@example.com\nAddress: 123 Main St"
    }]
  },
  2000: {
